...
# This setup script is used to build the T0WmaDataSvc pypi package.
# The version number comes from T0WmaDataSvc/__init__.py and needs to
...
from setup_build import list_packages, list_static_files, get_path_to_t0wmadatasvc_root, load_source

# Obnoxiously, there's a dependency cycle when building packages. We'd like
# to simply get the current T0WmaDataSvc version by using
...
# filename.
t0wmadatasvc_root = get_path_to_t0wmadatasvc_root()
t0wmadatasvc_package = load_source('temp_module', os.path.join(t0wmadatasvc_root,
                                                             'src',
                                                             'python',
                                                             'T0WmaDataSvc',
                                                             '__init__.py'))
t0wmadatasvc_version = t0wmadatasvc_package.__version__
